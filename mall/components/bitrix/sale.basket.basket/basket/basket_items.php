        ...
        <div id="basket_items_list">
                <table id="basket_items">
                        ...
                        <tbody>
                                ...
                                ?>
                                                <tr id="<?= $arItem["ID"] ?>" class="basket_item">
                                                        ...
                                                        ?>
                                                                                ...
                                                                                <div class="bx_ordercart_itemart">
                                                                                        ...
                                                                                        if ($bPropsColumn) :
                                                                                                foreach ($arItem["PROPS"] as $val) :
                                                                                                        ...
                                                                                                        echo "<span class='scu_name'>" . $val["NAME"] . ":</span>&nbsp;<span>" . $val["VALUE"] . "<span><br/>";
                                                                                                endforeach;
                                                                                        endif;
                                                                                        ?>
                                                                                </div>
                                                                                ...
                                                                                ?>
                                                                                                        <div class="bx_item_detail_scu_small_noadaptive <?= $full ?>">
                                                                                                                ...
                                                                                                                <div class="bx_scu_scroller_container">
                                                                                                                        ...
                                                                                                                        <div class="bx_scu">
                                                                                                                                <ul id="prop_<?= $arProp["CODE"] ?>_<?= $arItem["ID"] ?>" style="width: 200%; margin-left:0;" class="sku_prop_list">
                                                                                                                                        <?
                                                                                                                                        foreach ($arProp["VALUES"] as $valueId => $arSkuValue) :
                                                                                                                                                ...
                                                                                                                                                endforeach;
                                                                                                                                        ?>
                                                                                                                                                <li style="width:10%;" class="sku_prop<?= $selected ?>" data-value-id="<?= $arSkuValue["XML_ID"] ?>" data-element="<?= $arItem["ID"] ?>" data-property="<?= $arProp["CODE"] ?>">
                                                                                                                        ...
                                                                                                                        <div class="bx_size">
                                                                                                                                <ul id="prop_<?= $arProp["CODE"] ?>_<?= $arItem["ID"] ?>" style="width: 200%; margin-left:0;" class="sku_prop_list">
                                                                                                                                        ...
                                                                                                                                        foreach ($arProp["VALUES"] as $valueId => $arSkuValue) :
                                                                                                                                                ...
                                                                                                                                                endforeach;
                                                                                                                                        ?>
                                                                                                                                                <li style="width:10%;" class="sku_prop<?= $selected ?>" data-value-id="<?= ($arProp['TYPE'] == 'S' && $arProp['USER_TYPE'] == 'directory' ? $arSkuValue['XML_ID'] : $arSkuValue['NAME']); ?>" data-element="<?= $arItem["ID"] ?>" data-property="<?= $arProp["CODE"] ?>">
                                                                ...
                                                                ?>
                                                                        <td class="quantity">
                                                                                ...
                                                                                ?>
                                                                                <a href="javascript:void(0);" class="upd_quantity material-icons" onclick="setQuantity(<?= $arItem["ID"] ?>, <?= $arItem["MEASURE_RATIO"] ?>, 'down', <?= $useFloatQuantityJS ?>); updBasket('', <?= $arItem["ID"] ?>)">remove</a>
                                                                                <input type="text" id="QUANTITY_INPUT_<?= $arItem["ID"] ?>" name="QUANTITY_INPUT_<?= $arItem["ID"] ?>" maxlength="4" min="0" <?= $max ?> step="<?= $ratio ?>" value="<?= $arItem["QUANTITY"] ?>" onchange="updateQuantity('QUANTITY_INPUT_<?= $arItem["ID"] ?>', '<?= $arItem["ID"] ?>', <?= $ratio ?>, <?= $useFloatQuantityJS ?>);updBasket('', <?= $arItem["ID"] ?>)""
                                                                                                >
                                                                                                <a href=" javascript:void(0);" class="upd_quantity material-icons" onclick="setQuantity(<?= $arItem["ID"] ?>, <?= $arItem["MEASURE_RATIO"] ?>, 'up', <?= $useFloatQuantityJS ?>); updBasket('', <?= $arItem["ID"] ?>)">add</a>

                                                                                <?
                                                                                if (isset($arItem["MEASURE_TEXT"])) {
                                                                                ?>
                                                                                        <span class="measure"><?= $arItem["MEASURE_TEXT"] ?></span>
                                                                                <?
                                                                                }
                                                                                ?>
                                                        ...
                                                        if ($bDelayColumn || $bDeleteColumn) :
                                                                ...
                                                                <td class="control">
                                                                        ...
                                                                        if ($bDeleteColumn) :
                                                                        ?>
                                                                                <span class="remove material-icons" onclick="updBasket('del', <?= $arItem["ID"] ?>);">close</span>
                                                                        <?
                                                                        endif;
                                                                        if ($bDelayColumn) :
                                                                        ?>
                ...
                <div class="bx_ordercart_order_pay">
                        ...
                        <div style="clear:both;"></div>
                        <? $this->SetViewTarget("BASKET_CHECKOUT"); ?>
                        <div class="bx_ordercart_order_pay_center">
                                ...
                                ?>
                                <a id="startOrdering" href="/personal/order/make/" onclick="{() => {checkOut();_tmr.push({ type: 'reachGoal', id: 3322476, goal: 'personal/order'});}}" class="btn"><?= GetMessage("SALE_ORDER") ?></a>
                        </div>
                        <? $this->EndViewTarget(); ?>
                </div>
        </div>
