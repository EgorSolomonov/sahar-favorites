...
?><div class="<? echo $arCurView['CONT']; ?> container-fluid"><?
	...
	switch ($arParams['VIEW_MODE'])
	{
		case 'LINE':
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="col-xs-3 col-sm-3 col-md-2 col-lg-2 col-xl-2 col-xxl-1 cat_center">
				<a
