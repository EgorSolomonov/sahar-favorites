						...
						<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-about-order-inner-container">
							<div class="row">
								...
								<div class="col-md-2 col-sm-6 sale-order-detail-about-order-inner-container-repeat">
									<a href="<?=$arResult["URL_TO_COPY"]?>&amp;COPY_ORDER=Y" class="sale-order-detail-about-order-inner-container-repeat-button btn">
									...
									{
										?>
										<a href="<?=$arResult["URL_TO_CANCEL"]?>" class="sale-order-detail-about-order-inner-container-repeat-cancel btn btn_grey">
													...
													if ($payment['PAY_SYSTEM']["IS_CASH"] !== "Y")
													{
														...
														<div class="col-md-2 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods-button-container">
															...
															else
															{
																...
																{
																	?>
																	<a class="btn sale-order-detail-payment-options-methods-button-element"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																	<?
																}
															}
															?>
