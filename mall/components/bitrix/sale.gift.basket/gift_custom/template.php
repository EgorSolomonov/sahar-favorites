...
if (!empty($arResult['ITEMS']))
{
			...
			foreach ($skuProps as &$arProp)
			{
				...
				<div class="<? echo $strClass; ?>" id="#ITEM#_prop_<? echo $arProp['ID']; ?>_cont">
					...
					<div class="bx_size_scroller_container">
						<div class="bx_size">
							<ul id="#ITEM#_prop_<? echo $arProp['ID']; ?>_list" style="width: <? echo $strWidth; ?>; height: 100%"><?
	...
	<div class="bx_item_list_slide active owl-carousel-gift owl-carousel owl-theme"><?
	...
	?>
		<div class="bx_catalog_item_controls">
			...
			?>
			<div class="bx_catalog_item_controls_blocktwo">
				<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="gift_button bx_medium" href="javascript:void(0)" rel="nofollow"><?
					echo('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CVP_TPL_MESS_BTN_BUY_GIFT'));
					?></a>
			</div>
		</div>
